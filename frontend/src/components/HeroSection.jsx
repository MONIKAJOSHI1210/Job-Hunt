...
const navigate=useNavigate();
  ...
  return (
    <div className='text-center'>
        ...
        <span className='px-4 py-2 rounded-full bg-grey-100 text-[#F83002] font-medium'> No.1 Job Hunt Website</span>
        <h1 className='text-5xl font-bold'>Search ,Apply & <br></br>Get Your <span className='text-[#6A38C2]'>Dream Jobs</span></h1>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa porro ipsam ullam minus ab?</p>
